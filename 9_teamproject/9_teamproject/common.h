...
void compare(char* texts, char* input, int x, int y, int timespent, float* maxsp, int* comp_count, int linecount);
void gettext(char*);
...
void swrite(char* ch, int* a, int* cnt, char input[], int level);